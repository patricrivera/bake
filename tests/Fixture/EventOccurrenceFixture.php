...
/**
 * EventOccurrenceFixture
 */
class EventOccurrenceFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'event_occurrence_ibfk_1' => ['type' => 'foreign', 'columns' => ['event_id'], 'references' => ['events', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'event_id' => 1,
                'duration' => 1,
                'startDateTime' => '2021-02-18 14:33:16',
                'endDateTime' => '2021-02-18 14:33:16',
            ],
        ];
        parent::init();
    }
